    ...
    <div className="rounded-lg border border-gray-300 bg-white p-4 shadow-sm">
      <form onSubmit={handleSubmit} className="mb-4">
        ...
        <input
          ...
          className="mb-3 block w-full rounded-md border-2 border-black p-2 placeholder-gray-600 text-black mb-8"
        />
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="rounded-md px-4 py-2 font-bold text-black bg-gray-300 hover:bg-gray-300 disabled:bg-gray-100 disabled:text-gray-400"
            disabled={quantity === 1}
            onClick={decrement}>
            -
          </button>
          <button
            type="button"
            className="rounded-md px-4 py-2 font-bold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300"
        ...
        <label
          className="mb-2 mt-4 block font-semibold text-gray-700"
          htmlFor="category">
          Category:
        </label>
        <select
          ...
          {categories.map(
            (
              category //Neat trick using map to create the options dynamically instead of hardcoding them
            ) => (
